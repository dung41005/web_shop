        ...
        textEditor: function () {
            $(".aiz-text-editor").each(function (el) {
                ...
                var InsertImageButton = function (context) {
                    ...
                    var lib_button = '<div class="input-group" data-toggle="aizuploader" data-multiple="true" data-type="image"><div class="form-control file-amount" style="padding: 5px; height: 31px;background-color: white;">Chá»n hÃ¬nh</div><input id="des_text_img" type="hidden" name="des_text_img" class="selected-files"></div>';

                    // create button
                    var button = ui.button({
                        contents: lib_button,
                        tooltip: 'Chá»n hÃ¬nh tá»« thÆ° viá»‡n',
                    });
                ...
                $this.summernote({
                    ...
                    callbacks: {
                        ...
                        onInit: function() {
                            var editor = $(this);
                            //var lib_button = '<div class="input-group" data-toggle="aizuploader" data-multiple="true" data-type="image"><div class="form-control file-amount" style="padding: 5px; height: 31px;background-color: white;">Chá»n file</div><input id="des_text_img" type="hidden" name="des_text_img" class="selected-files"></div>';
    ...
    AIZ.extra = {
        ...
        plusMinus: function(){
            ...
            $('.aiz-plus-minus button').on('click', function(e) {
				...
				var originalPrice = parseInt($('#chosen_price').text().replace(/[^0-9]/g, ''));
                if (!isNaN(currentVal)) {
                    if (type == "minus") {
                        if (currentVal > input.attr("min")) {
                            input.val(currentVal - 1).change();
							var newPrice = originalPrice*(currentVal-1)/currentVal;
							$('#chosen_price').text(newPrice.toLocaleString())
                        }
